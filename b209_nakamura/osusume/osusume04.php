...
<img src="../img/aaa.png" width="40%">
    ...
    <button onclick="location.href='../games/hyakumanten.php'" class="button">詳しく</button>
    ...
    <div class="channel">
    <h2>らっだぁ</h2>
    <img src="../img/radao.jpg"width="40%">
    <button onclick="location.href='../games/radao.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=08>お気に入り登録</button>
    <script>
        function toggleFavorite(button) {
    var channelName = button.getAttribute("data-channel");
    if (button.innerText === "お気に入り登録") {
