...
<img src="../img/aaa.png" width="40%">    <header class="hed">
    ...
    <div class="channel">
    <h2>兄者弟者</h2>
    <img src="../img/2bro.jpg"width="70%">
    <button onclick="location.href='../games/norunie.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=19>お気に入り登録</button>
    <script>
    ...
    <div class="channel">
    <h2>ナポリの男たち</h2>
    <img src="../img/napolimen.jpg"width="40%">
    <button onclick="location.href='../games/napolimen.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=20>お気に入り登録</button>
    <script>
        function toggleFavorite(button) {
    var channelName = button.getAttribute("data-channel");
    if (button.innerText === "お気に入り登録") {
