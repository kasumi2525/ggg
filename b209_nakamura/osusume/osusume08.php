...
<img src="../img/aaa.png" width="40%">    <header class="hed">
    ...
    <div class="channel">
    <h2>狩野英孝</h2>
    <img src="../img/eikou.jpg"width="40%">
    <button onclick="location.href='../games/kanoeikou.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=13>お気に入り登録</button>
    <script>
    ...
    <div class="channel">
    <h2>Nintendo 公式チャンネル （よゐこ）</h2>
    <img src="../img/title.png"width="50%">
    <button onclick="location.href='../games/nintendo.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=14>お気に入り登録</button>
    <script>
        function toggleFavorite(button) {
    var channelName = button.getAttribute("data-channel");
    if (button.innerText === "お気に入り登録") {
