...
<img src="../img/aaa.png" width="40%">    <header class="hed">
    ...
    <div class="channel">
    <h2>日常組</h2>
    <img src="../img/nichijougumi.jpg"width="40%">
    <button onclick="location.href='../games/nichijo.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=17>お気に入り登録</button>
    <script>
    ...
    <div class="channel">
    <h2>White Tails【ワイテルズ】</h2>
    <img src="../img/waite.jpg"width="40%">
    <button onclick="location.href='../games/white.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=18>お気に入り登録</button>
    <script>
        function toggleFavorite(button) {
    var channelName = button.getAttribute("data-channel");
    if (button.innerText === "お気に入り登録") {
