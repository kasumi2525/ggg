...
<img src="../img/aaa.png" width="40%">    <header class="hed">
    ...
    <button onclick="location.href='../games/kiyo.php'" class="button">詳しく</button>
    ...
    <div class="channel">
    <h2>ガッチマン</h2>
    <img src="../img/gati.jpg"width="40%">
    <button onclick="location.href='../games/gatchman.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=10>お気に入り登録</button>
    <script>
        function toggleFavorite(button) {
    var channelName = button.getAttribute("data-channel");
    if (button.innerText === "お気に入り登録") {
