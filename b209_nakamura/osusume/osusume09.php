...
<img src="../img/aaa.png" width="40%">    <header class="hed">
    ...
    <div class="channel">
    <h2>LEOの遊び場【山田涼介】</h2>
    <img src="../img/yamada.jpg"width="40%">
    <button onclick="location.href='../games/leo.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=15>お気に入り登録</button>
    <script>
    ...
    <div class="channel">
    <h2>花江夏樹</h2>
    <img src="../img/hanae.jpg"width="64%">
    <button onclick="location.href='../games/hanae.php'" class="button">詳しく</button>
    <button onclick="toggleFavorite(this)" class="button" data-channel=16>お気に入り登録</button>
    <script>
        function toggleFavorite(button) {
    var channelName = button.getAttribute("data-channel");
    if (button.innerText === "お気に入り登録") {
